<header id="page-topbar">
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="{{ (!empty(Auth::user()->image)) ? url('upload/admin/'.Auth::user()->image): url('upload/emptyimage.jpeg') }}"
                                    alt="Header Avatar">
                    ...
                    <x-responsive-nav-link :href="route('logout')"
                        ...
                        <i class="ri-shut-down-line align-middle me-1 text-danger">Logout</i>
